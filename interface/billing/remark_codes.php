...
'M11' => 'DME, orthotics and prosthetics must be billed to the DME carrier who services the patients zip code.',
...
'M18' => 'Certain services may be approved for home use. Neither a hospital nor a Skilled Nursing Facility (SNF) is considered to be a patients home.',
...
'M32' => 'Alert: This is a conditional payment made pending a decision on this service by the patients primary payer. This payment may be subject to refund upon your receipt of any additional payment for this service from another payer. You must contact this office immediately upon receipt of an additional payment for this service.',
...
'M40' => 'Claim must be assigned and must be filed by the practitioners employer.',
...
'MA10' => 'Alert: The patients payment was in excess of the amount owed. You must refund the overpayment to the patient.',
...
'MA111' => 'Missing/incomplete/invalid purchase price of the test(s) and/or the performing laboratorys name and address.',
...
'MA17' => 'We are the primary payer and have paid at the primary rate. You must contact the patients other insurer to refund any excess it may have paid due to its erroneous primary payment.',
'MA18' => 'Alert: The claim information is also being forwarded to the patients supplemental insurer. Send any questions regarding supplemental benefits to them.',
...
'MA37' => 'Missing/incomplete/invalid patients address.',
...
'MA88' => 'Missing/incomplete/invalid insureds address and/or telephone number for the primary payer.',
'MA89' => 'Missing/incomplete/invalid patients relationship to the insured for the primary payer.',
...
'N129' => 'Not eligible due to the patients age.',
...
'N135' => 'Record fees are the patients responsibility and limited to the specified co-payment.',
'N136' => 'Alert: To obtain information on the process to file an appeal in Arizona, call the Departments Consumer Assistance Office at (602) 912-8444 or (800) 325-2548.',
'N137' => 'Alert: The provider acting on the Members behalf, may file an appeal with the Payer. The provider, acting on the Members behalf, may file a complaint with the State Insurance Regulatory Authority without first filing an appeal, if the coverage decision involves an urgent condition for which care has not been rendered. The address may be obtained from the State Insurance Regulatory Authority.',
'N138' => 'Alert: In the event you disagree with the Dental Advisors opinion and have additional information relative to the case, you may submit radiographs to the Dental Advisor Unit at the subscribers dental insurance carrier for a second Independent Dental Advisor Review.',
'N139' => 'Alert: Under the Code of Federal Regulations, Chapter 32, Section 199.13 a non-participating provider is not an appropriate appealing party. Therefore, if you disagree with the Dental Advisors opinion, you may appeal the determination if appointed in writing, by the beneficiary, to act as his/her representative. Should you be appointed as a representative, submit a copy of this letter, a signed statement explaining the matter in which you disagree, and any radiographs and relevant information to the subscribers Dental insurance carrier within 90 days from the date of this letter.',
'N140' => 'Alert: You have not been designated as an authorized OCONUS provider therefore are not considered an appropriate appealing party. If the beneficiary has appointed you, in writing, to act as his/her representative and you disagree with the Dental Advisors opinion, you may appeal by submitting a copy of this letter, a signed statement explaining the matter in which you disagree, and any relevant information to the subscribers Dental insurance carrier within 90 days from the date of this letter.',
...
'N154' => 'Alert: This payment was delayed for correction of providers mailing address.',
...
'N189' => 'Alert: This service has been paid as a one-time exception to the plans benefit restrictions.',
...
'N220' => 'Alert: See the payers web site or contact the payers Customer Service department to obtain forms and instructions for filing a provider dispute.',
...
'N387' => 'Alert: Submit this claim to the patients other insurer for potential payment of supplemental benefits. We did not forward the claim information.',
...
'N405' => 'This service is only covered when the donors insurer(s) do not provide coverage for the service.',
'N406' => 'This service is only covered when the recipients insurer(s) do not provide coverage for the service.',
...
'N419' => 'Claim payment was the result of a payers retroactive adjustment due to a retroactive rate change.',
'N42' => 'Missing mental health assessment.',
'N420' => 'Claim payment was the result of a payers retroactive adjustment due to a Coordination of Benefits or Third Party Liability Recovery.',
'N421' => 'Claim payment was the result of a payers retroactive adjustment due to a review organization decision.',
'N422' => 'Claim payment was the result of a payers retroactive adjustment due to a payers contract incentive program.',
'N423' => 'Claim payment was the result of a payers retroactive adjustment due to a non standard program.',
...
'N510' => 'Alert: A current inquiry shows the member’s Consumer Spending Account does not contain sufficient funds to cover the members liability for this claim/service. Actual payment from the Consumer Spending Account will depend on the availability of funds and determination of eligible services at the time of payment processing.',
...
'N52' => 'Patient not enrolled in the billing providers managed care plan on the date of service.',
...
'N536' => 'We are not changing the prior payers determination of patient responsibility, which you may collect, as this service is not covered by us.',
...
'N548' => 'Alert: Patients calendar year deductible has been met.',
'N549' => 'Alert: Patients calendar year out-of-pocket maximum has been met.',
...
'N582' => 'Benefits suspended pending the patients cooperation.',
'N583' => 'Patient was not an occupant of our insured vehicle and therefore, is not an eligible injured person.',
'N584' => 'Not covered based on the insureds noncompliance with policy or statutory conditions.',
...
'N597' => 'Adjusted based on a medical/dental providers apportionment of care between related injuries and other unrelated medical/dental conditions/injuries.',
...
'N609' => '80% of the providers billed amount is being recommended for payment according to Act 6.',
...
'N655' => 'Payment based on providers geographic region.',
...
'N697' => 'Alert: This reversal is due to a payers retroactive contract incentive program adjustment.',
...
'N740' => 'The members Consumer Spending Account does not contain sufficient funds to cover the members liability for this claim/service.',
...
'N88' => 'Alert: This payment is being made conditionally. An HHA episode of care notice has been filed for this patient. When a patient is treated under a HHA episode of care, consolidated billing requires that certain therapy services and supplies, such as this, be included in the HHAs payment. This payment will need to be recouped from you if we establish that the patient is concurrently receiving treatment under a HHA episode of care.',
