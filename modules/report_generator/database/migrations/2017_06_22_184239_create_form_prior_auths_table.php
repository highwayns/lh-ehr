...
class CreateFormPriorAuthsTable extends Migration
{
    /**
     * Run the migrations.
     * Creates form_prior_auths table.
     * From UI, Select Patient -> Encounter -> Miscellaneous -> Prior Authorization Form. | Select Patient -> Encounter -> Patient/CLient -> Visit Forms -> Prior Authorization Form.
     * @author Priyanshu Sinha <pksinha217@gmail.com>
     * @return void
     */
    public function up()
    {
        Schema::create('form_prior_auths', function (Blueprint $table) {
	    ...
	    $table->string('prior_auth_number', 35)->comment = "Auth Number";
    ...
    {
        Schema::dropIfExists('form_prior_auths');
    }
}
