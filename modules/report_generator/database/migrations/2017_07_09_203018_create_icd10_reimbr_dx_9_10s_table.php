...
class CreateIcd10ReimbrDx910sTable extends Migration
{
     ...
     * This creates icd10_reimbr_dx_9_10s table. (Same as icd10_reimbr_dx_9_10 table.)
     * @author Priyanshu Sinha <pksinha217@gmail.com>
     * @return void
     */
    public function up()
    {
        Schema::create('icd10_reimbr_dx_9_10s', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('icd10_reimbr_dx_9_10s');
    }
}
