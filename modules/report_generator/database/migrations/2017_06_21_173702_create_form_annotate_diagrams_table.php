...
class CreateFormAnnotateDiagramsTable extends Migration
{
     ...
     * From UI, Select Patient -> Encounter -> Clinical -> Annotatable Diagram. | Select Patient -> Encounter -> Patient/CLient -> Visit Forms -> Annotatable Diagram.
    ...
    public function up()
    {
        Schema::create('form_annotate_diagrams', function (Blueprint $table) {
            $table->increments('id')->comment = "Aotoincrement. Primary Key";
	    ...
	    $table->string('imagedata')->nullable()->comment = "Image Data Dorectoey";
	    $table->string('dyntitle')->comment = "Digram name";
