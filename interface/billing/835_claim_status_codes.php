...
'102' => 'Newborns charges processed on mothers claim.',
...
'106' => 'This amount is not entitys responsibility. Note: This code requires use of an Entity Code.',
...
'111' => 'At the policyholders request these claims cannot be submitted electronically.',
...
'124' => 'Entitys name, address, phone and id number. Note: This code requires use of an Entity Code.',
'125' => 'Entitys name. Note: This code requires use of an Entity Code.',
'126' => 'Entitys address. Note: This code requires use of an Entity Code.',
'127' => 'Entitys Communication Number. Note: This code requires use of an Entity Code.',
'128' => 'Entitys tax id. Note: This code requires use of an Entity Code.',
'129' => 'Entitys Blue Cross provider id. Note: This code requires use of an Entity Code.',
'130' => 'Entitys Blue Shield provider id. Note: This code requires use of an Entity Code.',
'131' => 'Entitys Medicare provider id. Note: This code requires use of an Entity Code.',
'132' => 'Entitys Medicaid provider id. Note: This code requires use of an Entity Code.',
'133' => 'Entitys UPIN. Note: This code requires use of an Entity Code.',
'134' => 'Entitys CHAMPUS provider id. Note: This code requires use of an Entity Code.',
'135' => 'Entitys commercial provider id. Note: This code requires use of an Entity Code.',
'136' => 'Entitys health industry id number. Note: This code requires use of an Entity Code.',
'137' => 'Entitys plan network id. Note: This code requires use of an Entity Code.',
'138' => 'Entitys site id . Note: This code requires use of an Entity Code.',
'139' => 'Entitys health maintenance provider id (HMO). Note: This code requires use of an Entity Code.',
'140' => 'Entitys preferred provider organization id (PPO). Note: This code requires use of an Entity Code.',
'141' => 'Entitys administrative services organization id (ASO). Note: This code requires use of an Entity Code.',
'142' => 'Entitys license/certification number. Note: This code requires use of an Entity Code.',
'143' => 'Entitys state license number. Note: This code requires use of an Entity Code.',
'144' => 'Entitys specialty license number. Note: This code requires use of an Entity Code.',
'145' => 'Entitys specialty/taxonomy code. Note: This code requires use of an Entity Code.',
'146' => 'Entitys anesthesia license number. Note: This code requires use of an Entity Code.',
'147' => 'Entitys qualification degree/designation (e.g. RN,PhD,MD). Note: This code requires use of an Entity Code.',
'148' => 'Entitys social security number. Note: This code requires use of an Entity Code.',
'149' => 'Entitys employer id. Note: This code requires use of an Entity Code.',
'150' => 'Entitys drug enforcement agency (DEA) number. Note: This code requires use of an Entity Code.',
'152' => 'Pharmacy processor number.',
'153' => 'Entitys id number. Note: This code requires use of an Entity Code.',
'154' => 'Relationship of surgeon & assistant surgeon.',
'155' => 'Entitys relationship to patient. Note: This code requires use of an Entity Code.',
'156' => 'Patient relationship to subscriber',
'157' => 'Entitys Gender. Note: This code requires use of an Entity Code.',
'158' => 'Entitys date of birth. Note: This code requires use of an Entity Code.',
'159' => 'Entitys date of death. Note: This code requires use of an Entity Code.',
'160' => 'Entitys marital status. Note: This code requires use of an Entity Code.',
'161' => 'Entitys employment status. Note: This code requires use of an Entity Code.',
'162' => 'Entitys health insurance claim number (HICN). Note: This code requires use of an Entity Code.',
'163' => 'Entitys policy number. Note: This code requires use of an Entity Code. This change effective 9/1/2016: Entitys policy/group number. Note: This code requires use of an Entity Code.',
'164' => 'Entitys contract/member number. Note: This code requires use of an Entity Code.',
'165' => 'Entitys employer name, address and phone. Note: This code requires use of an Entity Code.',
'166' => 'Entitys employer name. Note: This code requires use of an Entity Code.',
'167' => 'Entitys employer address. Note: This code requires use of an Entity Code.',
'168' => 'Entitys employer phone number. Note: This code requires use of an Entity Code.',
'170' => 'Entitys employee id. Note: This code requires use of an Entity Code.',
'171' => 'Other insurance coverage information (health, liability, auto, etc.).',
'172' => 'Other employer name, address and telephone number.',
'173' => 'Entitys name, address, phone, gender, DOB, marital status, employment status and relation to subscriber. Note: This code requires use of an Entity Code.',
'174' => 'Entitys student status. Note: This code requires use of an Entity Code.',
'175' => 'Entitys school name. Note: This code requires use of an Entity Code.',
'176' => 'Entitys school address. Note: This code requires use of an Entity Code.',
'177' => 'Transplant recipients name, date of birth, gender, relationship to insured.',
...
'252' => 'Entitys authorization/certification number. Note: This code requires the use of an Entity Code. This change effective 9/1/2016: Entitys prior authorization/certification number. Note: This code requires the use of an Entity Code.',
...
'286' => 'Other payers Explanation of Benefits/payment information.',
...
'431' => 'Patients condition/functional status at time of service.',
...
'466' => 'Entitys Original Signature. Note: This code requires use of an Entity Code.',
...
'478' => 'Claim submitters identifier',
'479' => 'Other Carrier payer ID is missing or invalid',
'480' => 'Entitys claim filing indicator. Note: This code requires use of an Entity Code.',
...
'500' => 'Entitys Postal/Zip Code. Note: This code requires use of an Entity Code.',
'501' => 'Entitys State/Province. Note: This code requires use of an Entity Code.',
'502' => 'Entitys City. Note: This code requires use of an Entity Code.',
'503' => 'Entitys Street Address. Note: This code requires use of an Entity Code.',
'504' => 'Entitys Last Name. Note: This code requires use of an Entity Code.',
'505' => 'Entitys First Name. Note: This code requires use of an Entity Code.',
...
'512' => 'Length invalid for receivers application system. Note: At least one other status code is required to identify the data element in error.',
'513' => 'HIPPS Rate Code for services Rendered',
'514' => 'Entitys Middle Name Note: This code requires use of an Entity Code.',
'515' => 'Managed Care review',
'516' => 'Other Entitys Adjudication or Payment/Remittance Date. Note: An Entity code is required to identify the Other Payer Entity, i.e. primary, secondary.',
...
'560' => 'Entitys Additional/Secondary Identifier. Note: This code requires use of an Entity Code.',
'561' => 'Entitys Contact Name. Note: This code requires use of an Entity Code.',
'562' => 'Entitys National Provider Identifier (NPI). Note: This code requires use of an Entity Code.',
'563' => 'Entitys Tax Amount. Note: This code requires use of an Entity Code.',
'564' => 'EPSDT Indicator',
...
'663' => 'Entitys Group Name. Note: This code requires use of an Entity Code.',
...
'672' => 'Other Payers payment information is out of balance',
...
'679' => 'Submit newborn services on mothers claim',
'680' => 'Entitys Country. Note: This code requires use of an Entity Code.',
...
'695' => 'Entitys Country Subdivision Code. Note: This code requires use of an Entity Code.',
...
'733' => 'Prefix for entitys contract/member number.',
...
'755' => 'Entitys primary identifier. Note: This code requires the use of an Entity Code.',
'756' => 'Entitys Received Date. Note: This code requires the use of an Entity Code.',
'757' => 'Last seen date.',
'758' => 'Repriced approved HCPCS code.',
'759' => 'Round trip purpose description.',
'760' => 'Tooth status code.',
'761' => 'Entitys referral number. Note: This code requires the use of an Entity Code.',
