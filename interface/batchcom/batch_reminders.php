...
<table>
 <tr>
  <td class='text' align='left' colspan="3"><br>
   ...
   <?php if (report_id) { ?>
     <br><input type="button" value="<?php echo xla('Back'); ?>" onClick="top.restoreSession(); window.open('../reports/report_results.php','_self',false)"><br><br><br>
   <?php } else { ?>
     <br><input type="button" value="<?php echo xla('Close'); ?>" onClick="window.close()"><br><br><br>
   <?php } ?>
