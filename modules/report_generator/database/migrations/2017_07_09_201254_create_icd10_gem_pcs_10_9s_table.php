...
class CreateIcd10GemPcs109sTable extends Migration
{
    /**
     * Run the migrations.
     * This creates icd10_gem_pcs_10_9s table. (Same as icd10_gem_pcs_10_9 table earlier.)
    ...
    public function up()
    {
        Schema::create('icd10_gem_pcs_10_9s', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('icd10_gem_pcs_10_9s');
    }
}
