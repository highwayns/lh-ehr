 ...
 *
 * @file AbstractAnnotateModel.php
 *
 * @brief This file contains the AbstractAnnotateModel class, used to model form contents.
 *
 */
 ...
 *
 */
abstract class AbstractAnnotateModel extends ORDataObject {
     ...
     */
    public function AbstractAnnotateModel($table, $id="") {
    ...
    function set_imagedata($imagedata) {
        if (!empty($imagedata)) {
    ...
    function get_dyntitle() {
        return $this->dyntitle;
    }

    function set_dyntitle($dyntitle) {
        if (!empty($dyntitle)) {
            $this->dyntitle = $dyntitle;
        }
	else
	{
	    $this->dyntitle = "New Diagram";
	}		
	}
}
?>